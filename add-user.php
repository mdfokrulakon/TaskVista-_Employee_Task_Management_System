<?php 
session_start();
// This check ensures only a logged-in admin can access this page.
...
<head>
    ...
    <style>
        * {
        ...
        .header {
            display: flex;
            /* MODIFIED: Changed from flex-end to space-between */
        ...
        /* --- NEW: CSS for the animated title --- */
        .animated-title-text {
            font-size: 32px;
            font-weight: 800;
            letter-spacing: 1px;
        ...
        /* Page Title & Form Styles - UNCHANGED */
...
<body>
    <div class="container">
        ...
        <div class="sidebar" id="sidebar">
            <div class="logo">
                <h1><i class="fas fa-users-cog"></i> <span>Admin Panel</span></h1>
            </div>
            <ul class="nav-links">
        ...
        <!-- Wrapper for main content to manage layout and scrolling -->
        <div class="main-content-wrapper">
            <!-- Header (Now Sticky with Title) -->
            <div class="header">
                <!-- NEW: Animated title added here -->
                <div class="animated-title-text">TaskViTaskVista - Employee Task Management System</div>
                <div class="user-info">
                ...
                <div class="form-container">
                    <form method="POST" action="app/add-user.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="user_name" class="form-control" placeholder="e.g. johndoe" required>
                        </div>
                        <div class="form-group">
