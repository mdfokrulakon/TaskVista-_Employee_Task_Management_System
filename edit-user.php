    ...
    <div class="container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav-links">
                ...
                <!-- MODIFIED: Set Manage Users to active -->
        ...
        <div class="main-content">
            ...
            <div class="dashboard-title">
                <h2>Edit User</h2>
                <p>Modify the details for <?=$user['full_name']?>.</p>
            </div>
            ...
            <div class="form-container">
                <form method="POST" action="app/update-user.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="user_name" value="<?=$user['username']?>" class="form-control" placeholder="Username">
                    </div>
                    <div class="form-group">
                        <label for="password">New Password</label>
                        <input type="password" name="password" class="form-control" placeholder="Leave blank to keep password unchanged">
                    </div>
...
<?php }else{ 
   // Redirect if not a logged-in admin
   $em = "First login";
